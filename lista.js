...
const furiaMaiusculo = furiaCS.map(function(jogador) {
    return jogador.toUpperCase();
});
console.log(furiaMaiusculo);

// 4) Usando a função .sort, ordene a lista com os nomes maiúsculos

const furiaOrdenado = furiaMaiusculo.sort();
console.log(furiaOrdenado);

// 5) Usando a função .filter, filtre apenas os nomes que começam com "y"

const nomesY = furiaMaiusculo.filter(jogador => jogador.startsWith("Y"));
console.log(nomesY);